...
AmumuAnalyzer::beginJob()
{
  ...
  histos1D_[ "DeltaR_of_2_mu_decayed_from_same_higgs"]=fileService->make<TH1D>("DeltaR_of_2_mu_decayed_from_same_higgs","DeltaR_of_2_mu_decayed_from_same_higgs--heavy125_light19", 100, 0, 6.0);
